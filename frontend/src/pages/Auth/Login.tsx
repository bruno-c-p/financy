          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <label
                  htmlFor="remember"
                  className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-grayscale-600"
                >
                  Lembrar-me
                </label>
              </div>
              <Link
                to="/forgot-password"
                className="text-sm font-medium text-brand-base hover:text-brand-dark"
              >
                Recuperar senha
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-11 text-base font-semibold mt-2 bg-brand-base hover:bg-brand-dark"
              disabled={loading}
            >
              {loading ? (
                <>
